...
import com.example.operations.DTO.RequestDTO;
import com.example.operations.Exception.*;
...
public class OperationsService {
    ...
    public Map<String, String> processArrival(Long flightId ) {
        ...
        try {
            ...
            throw new GateUnavailableException("Gate allocation failed for flight " + flightId);
        }
        ...
        try {
            ...
            throw new CrewUnavailableException("Baggage crew assignment failed.");
        }
        ...
        try {
            ...
            throw new CrewUnavailableException("Fueling crew assignment failed.");
        }
        try {
